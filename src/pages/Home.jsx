...
const Home = () => {
  ...
  const handleRange300to600 = () => {
    ...
    const filterPrice = AllRestaurants.filter((res) => {
      ...
      return price >= lowRange && price <= highRange;
    });
      ...
      <div className="container min-h-screen pt-24 pb-32 md:mx-auto md:w-3/4">
        {FilteredRestaurants && AllRestaurants ? (
          <>
            ...
            {FoodCategories && (
              <div className="relative hidden md:block">
                <h2 className="pt-5 pb-5 text-xl text-left font-GrotBlack sm:text-2xl">
                  What's on your mind?
                </h2>
                ...
                <div className="foodCategory overflow-x-scroll overflow-y-hidden scroll-smooth scrollbar-hide 2xl:max-w-[1080px]">
                  <div className="flex px-3 md:gap-6 md:px-0">
            ...
            <h2 className="pt-10 pb-5 text-xl text-center font-GrotBlack sm:text-2xl 2xl:text-left">
              Restaurants with online food delivery in {UserLocation?.city}
            </h2>

            <div className="flex flex-col items-center justify-center gap-5 mb-5 buttons 2xl:justify-between 2xl:pr-24 font-GrotReg xl:flex-row xl:gap-0">
            ...
            {ErrorMessage && (
              <div className="mt-5 mb-3 text-2xl text-center font-ProximaNovaBlack">
                {ErrorMessage}
              </div>
            )}
