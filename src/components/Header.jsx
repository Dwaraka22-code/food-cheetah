  ...
  return (
    <>
      <header className="p-3 shadow-lg fixed w-full z-10 bg-white h-[85px]">
        <nav className="container flex items-center justify-between mx-auto md:w-[87%]">
          ...
          <ul className="items-center hidden gap-14 xl:flex text-customblack-1 font-GrotMed mr-12 ">
            <li>
